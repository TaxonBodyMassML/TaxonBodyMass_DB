...
# (list and fixes generated by Claude, so better to distrust and remove records)
FixOutlierValues <- FALSE
...
if (dir.exists(ms_dir)) {
  writeLines(c(
    ...
    sprintf('\\newcommand{\\nRemovedHighRange}{%s\\xspace}',
            formatC(n_removed_high_range, format = 'd', big.mark = ','))
